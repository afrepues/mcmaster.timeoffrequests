...
def setup_product():
    ...
    import mcmaster.timeoffrequests
    zcml.load_config('configure.zcml', mcmaster.timeoffrequests)
    ...
    ztc.installPackage('mcmaster.timeoffrequests')
...
setup_product()
ptc.setupPloneSite(products=['mcmaster.timeoffrequests'])
